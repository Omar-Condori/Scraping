#!/usr/bin/env python3
"""
Sistema de Análisis de Noticias con Regresión Logística, KNN, Naive Bayes y K-Means
Implementa comparación entre los cuatro algoritmos de ML
"""
...
class CategoryClassifierML(NewsAnalyzerML):
    """Clasificador automático de categorías con LR, KNN, Naive Bayes y K-Means"""
    
    def train_category_classifiers(self):
        """Entrenar modelos LR, KNN, Naive Bayes y K-Means para clasificar categorías"""
        print("\n🎯 CLASIFICACIÓN AUTOMÁTICA DE CATEGORÍAS (LR vs KNN vs Naive Bayes vs K-Means)")
        print("=" * 90)
        ...
        accuracies = {'lr': accuracy_lr, 'knn': accuracy_knn, 'nb': accuracy_nb, 'kmeans': accuracy_kmeans}
        ...
        best_predictions = y_pred_lr if best_model == 'lr' else y_pred_knn if best_model == 'knn' else y_pred_nb if best_model == 'nb' else y_pred_kmeans
...
class QualityDetectorML(NewsAnalyzerML):
    """Detector de calidad con LR, KNN, Naive Bayes y K-Means"""
    
    def train_quality_detectors(self):
        """Entrenar modelos LR, KNN, Naive Bayes y K-Means para detectar calidad"""
        print("\n🔍 DETECCIÓN DE CALIDAD DE CONTENIDO (LR vs KNN vs Naive Bayes vs K-Means)")
        print("=" * 90)
...
class SentimentAnalyzerML(NewsAnalyzerML):
    """Analizador de sentimientos con LR, KNN, Naive Bayes y K-Means"""
    
    def analyze_sentiments_ml(self):
        """Analizar sentimientos con los cuatro modelos"""
        print("\n😊 ANÁLISIS DE SENTIMIENTOS (LR vs KNN vs Naive Bayes vs K-Means)")
        print("=" * 90)
...
class EngagementPredictorML(NewsAnalyzerML):
    """Predictor de engagement con LR, KNN, Naive Bayes y K-Means"""
    
    def train_engagement_predictors(self):
        """Entrenar modelos LR, KNN, Naive Bayes y K-Means para predecir engagement"""
        print("\n📈 PREDICCIÓN DE ENGAGEMENT (LR vs KNN vs Naive Bayes vs K-Means)")
        print("=" * 90)
...
class SourceClassifierML(NewsAnalyzerML):
    """Clasificador de fuentes con LR, KNN, Naive Bayes y K-Means"""
    
    def train_source_classifiers(self):
        """Entrenar modelos LR, KNN, Naive Bayes y K-Means para clasificar fuentes"""
        print("\n📰 CLASIFICACIÓN DE FUENTES (LR vs KNN vs Naive Bayes vs K-Means)")
        print("=" * 90)
...
def main():
    """Función principal para ejecutar análisis comparativo LR vs KNN vs Naive Bayes vs K-Means"""
    print("🚀 SISTEMA DE ANÁLISIS DE NOTICIAS: REGRESIÓN LOGÍSTICA vs KNN vs NAIVE BAYES vs K-MEANS")
    print("=" * 100)
    ...
    # Resumen final
    print("\n🏆 RESUMEN COMPARATIVO: REGRESIÓN LOGÍSTICA vs KNN vs NAIVE BAYES vs K-MEANS")
    print("=" * 100)
    ...
    print("   1. ✅ Clasificación automática de categorías (LR vs KNN vs Naive Bayes vs K-Means)")
    print("   2. ✅ Detección de calidad de contenido (LR vs KNN vs Naive Bayes vs K-Means)")
    print("   3. ✅ Análisis de sentimientos (LR vs KNN vs Naive Bayes vs K-Means)")
    print("   4. ✅ Predicción de engagement (LR vs KNN vs Naive Bayes vs K-Means)")
    print("   5. ✅ Clasificación de fuentes (LR vs KNN vs Naive Bayes vs K-Means)")
