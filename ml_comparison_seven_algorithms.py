#!/usr/bin/env python3
"""
Sistema de Análisis de Noticias con Regresión Logística, KNN, Naive Bayes, K-Means, Árbol de Decisión, ARIMA y Suavizado Exponencial
Implementa comparación entre los siete algoritmos de ML
"""
...
class CategoryClassifierML(NewsAnalyzerML):
    """Clasificador automático de categorías con LR, KNN, Naive Bayes, K-Means, Árbol de Decisión, ARIMA y Suavizado Exponencial"""
    
    def train_category_classifiers(self):
        """Entrenar modelos LR, KNN, Naive Bayes, K-Means, Árbol de Decisión, ARIMA y Suavizado Exponencial para clasificar categorías"""
        print("\n🎯 CLASIFICACIÓN AUTOMÁTICA DE CATEGORÍAS (LR vs KNN vs Naive Bayes vs K-MEANS vs ÁRBOL DE DECISIÓN vs ARIMA vs SUAVIZADO EXPONENCIAL)")
        print("=" * 140)
        ...
        accuracies = {'lr': accuracy_lr, 'knn': accuracy_knn, 'nb': accuracy_nb, 'kmeans': accuracy_kmeans, 'tree': accuracy_tree, 'arima': accuracy_arima, 'exponential': accuracy_exponential}
...
def main():
    """Función principal para ejecutar análisis comparativo LR vs KNN vs Naive Bayes vs K-Means vs Árbol de Decisión vs ARIMA vs Suavizado Exponencial"""
    print("🚀 SISTEMA DE ANÁLISIS DE NOTICIAS: REGRESIÓN LOGÍSTICA vs KNN vs NAIVE BAYES vs K-MEANS vs ÁRBOL DE DECISIÓN vs ARIMA vs SUAVIZADO EXPONENCIAL")
    print("=" * 140)
    ...
    # Resumen final
    print("\n🏆 RESUMEN COMPARATIVO: REGRESIÓN LOGÍSTICA vs KNN vs NAIVE BAYES vs K-MEANS vs ÁRBOL DE DECISIÓN vs ARIMA vs SUAVIZADO EXPONENCIAL")
    print("=" * 140)
    ...
    print("   1. ✅ Clasificación automática de categorías (LR vs KNN vs Naive Bayes vs K-Means vs Árbol de Decisión vs ARIMA vs Suavizado Exponencial)")
